            ...
            <main class="mt-5">
                <form method="POST" action="{{url("/satin-al")}}">
                    ...
                    <div class="form-group mt-2">
                        <x-input label="Ad Soyad" placeholder="Kart üzerindeki ad soyad" field="name" value=""/>
                    </div>

                    <div class="form-group mt-2">
                        <x-input label="Kart No" placeholder="16 haneli kart numaranızı giriniz" field="card_no" value=""/>
                    </div>
                    ...
                    <div class="form-group mt-2">
                        <x-input label="Cvc" placeholder="Cvc kodunu giriniz" field="cvc" type="number" value=""/>
                    </div>
